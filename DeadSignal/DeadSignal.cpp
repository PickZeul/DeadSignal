...
static_assert(PlayerSpritePaletteIndex(basicCharacter, 3, 5) == 0x0B
    && PlayerSpritePaletteIndex(mobilityCharacter, 1, 5) == 0x0A
    && PlayerSpritePaletteIndex(mobilityCharacter, 1, 4) == 0
    && PlayerSpritePaletteIndex(piercerCharacter, 3, 0) == 0x07
    && PlayerSpritePaletteIndex(piercerCharacter, 3, 2) == 0x0C
    && PlayerSpritePaletteIndex(heavyCharacter, 0, 4) == 0x0D
    && PlayerSpritePaletteIndex(heavyCharacter, 2, 5) == 0x08
    && PlayerSpritePaletteIndex(heavyCharacter, 7, 4) == 0x0D
    && PlayerSpritePaletteIndex(rapidCharacter, 7, 5) == 0x09
    && PlayerSpritePaletteIndex(rapidCharacter, 0, 5) == 0
    && PlayerSpritePaletteIndex(rapidCharacter, 0, 6) == 0x09
    && PlayerSpritePaletteIndex(rapidCharacter, 7, 6) == 0);
