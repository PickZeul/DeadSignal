...
{
    {
        ...
        },
        {
            { 0x00, 0x77, 0x77, 0x00 }, { 0x07, 0x77, 0x77, 0x70 },
            { 0x00, 0x75, 0x57, 0x00 }, { 0x00, 0x15, 0x51, 0x00 },
            { 0x03, 0x22, 0x22, 0x30 }, { 0x44, 0x32, 0xBB, 0x20 },
        ...
        },
        {
            ...
            { 0x00, 0x32, 0x22, 0x23 }, { 0x03, 0x2B, 0xB2, 0x44 },
            { 0x03, 0x22, 0x23, 0x44 }, { 0x00, 0x32, 0x22, 0x30 },
            { 0x00, 0x33, 0x33, 0x30 }, { 0x00, 0x33, 0x00, 0x30 },
            { 0x00, 0x30, 0x00, 0x30 }, { 0x06, 0x40, 0x00, 0x46 }
        },
        {
            { 0x00, 0x77, 0x77, 0x00 }, { 0x07, 0x77, 0x77, 0x70 },
            { 0x00, 0x75, 0x57, 0x00 }, { 0x00, 0x15, 0x51, 0x00 },
    ...
    },
    {
        ...
        },
        {
            ...
            { 0x06, 0x75, 0x57, 0x00 }, { 0x00, 0x15, 0x51, 0x00 },
            { 0x03, 0x22, 0x30, 0x00 }, { 0xAA, 0x32, 0x23, 0x00 },
            { 0x0A, 0x32, 0x23, 0x00 }, { 0x00, 0x32, 0x23, 0x00 },
            { 0x00, 0x30, 0x03, 0x00 }, { 0x00, 0x30, 0x03, 0x00 },
            { 0x00, 0x30, 0x03, 0x00 }, { 0x04, 0xA0, 0x0A, 0x40 }
        },
        {
            ...
            { 0x00, 0x03, 0x22, 0x30 }, { 0x00, 0x32, 0x23, 0xAA },
            { 0x00, 0x03, 0x22, 0x3A }, { 0x00, 0x03, 0x22, 0x30 },
            { 0x00, 0x03, 0x00, 0x30 }, { 0x00, 0x03, 0x00, 0x30 },
            { 0x00, 0x03, 0x00, 0x30 }, { 0x00, 0x4A, 0x00, 0xA4 }
        },
        {
            { 0x00, 0x07, 0x77, 0x00 }, { 0x00, 0x67, 0x77, 0x70 },
            { 0x06, 0x75, 0x57, 0x00 }, { 0x00, 0x15, 0x51, 0x00 },
            { 0x00, 0x32, 0x23, 0x00 }, { 0x0A, 0x32, 0x23, 0xAA },
            { 0x00, 0x32, 0x23, 0xA0 }, { 0x00, 0x32, 0x23, 0x00 },
            { 0x00, 0x30, 0x03, 0x00 }, { 0x00, 0x30, 0x03, 0x00 },
            { 0x00, 0x30, 0x03, 0x00 }, { 0x04, 0xA0, 0x0A, 0x40 }
        },
        {
    ...
    },
    {
        ...
        },
        {
            { 0x00, 0x07, 0x00, 0x00 }, { 0x00, 0x77, 0x70, 0x00 },
            { 0x00, 0x6C, 0x57, 0x00 }, { 0x00, 0x1C, 0x51, 0x00 },
            { 0x00, 0x3C, 0x23, 0x00 }, { 0x33, 0x0C, 0x23, 0x00 },
            { 0x03, 0x0C, 0x23, 0x00 }, { 0x00, 0x3C, 0x23, 0x00 },
            { 0x00, 0x3C, 0x33, 0x00 }, { 0x00, 0x30, 0x30, 0x00 },
            { 0x00, 0x30, 0x30, 0x00 }, { 0x03, 0x40, 0x04, 0x30 }
        },
        {
            ...
            { 0x00, 0x03, 0xC2, 0x30 }, { 0x00, 0x03, 0xC2, 0x3C },
        ...
        },
        {
            { 0x00, 0x07, 0x00, 0x00 }, { 0x00, 0x77, 0x70, 0x00 },
            { 0x00, 0x6C, 0x57, 0x00 }, { 0x00, 0x1C, 0x51, 0x00 },
            { 0x00, 0x3C, 0x23, 0x00 }, { 0x03, 0x3C, 0x23, 0x3C },
            { 0x00, 0x3C, 0x23, 0x30 }, { 0x00, 0x3C, 0x23, 0x00 },
            { 0x00, 0x3C, 0x33, 0x00 }, { 0x00, 0x30, 0x30, 0x00 },
            { 0x00, 0x30, 0x30, 0x00 }, { 0x03, 0x40, 0x04, 0x30 }
        },
    ...
    },
    {
        ...
        },
        {
            ...
            { 0xDD, 0x48, 0x88, 0x40 }, { 0x0D, 0x48, 0x88, 0x40 },
            { 0x0D, 0x44, 0x44, 0xD0 }, { 0x03, 0x30, 0x03, 0x30 },
            { 0x03, 0x30, 0x03, 0x30 }, { 0xDD, 0x40, 0x04, 0xDD }
        },
        {
            ...
            { 0x00, 0xD4, 0x44, 0x4D }, { 0x00, 0x33, 0x00, 0x33 },
            { 0x00, 0x33, 0x00, 0x33 }, { 0x0D, 0x40, 0x04, 0xDD }
        },
        {
            { 0x00, 0x37, 0x73, 0x00 }, { 0x03, 0x37, 0x73, 0x30 },
            { 0x03, 0x55, 0x55, 0x30 }, { 0x0D, 0x31, 0x13, 0xD0 },
            { 0xDD, 0x33, 0x33, 0xDD }, { 0xD4, 0x48, 0x88, 0x4D },
            { 0x0D, 0x48, 0x88, 0x4D }, { 0x0D, 0x48, 0x88, 0xDD },
            { 0x0D, 0x44, 0x44, 0xD0 }, { 0x03, 0x30, 0x03, 0x30 },
            { 0x03, 0x30, 0x03, 0x30 }, { 0xDD, 0x40, 0x04, 0xDD }
        },
        {
    ...
    },
    {
        ...
        },
        {
            { 0x00, 0x77, 0x00, 0x00 }, { 0x06, 0x77, 0x77, 0x00 },
            { 0x00, 0x75, 0x57, 0x70 }, { 0x00, 0x15, 0x51, 0x00 },
            { 0x04, 0x32, 0x23, 0x00 }, { 0x99, 0x43, 0x22, 0x00 },
            { 0x09, 0x43, 0x22, 0x30 }, { 0x00, 0x32, 0x23, 0x00 },
            { 0x00, 0x42, 0x24, 0x00 }, { 0x00, 0x30, 0x30, 0x00 },
            { 0x03, 0x00, 0x30, 0x00 }, { 0x44, 0x00, 0x04, 0x40 }
        },
        {
            ...
            { 0x00, 0x03, 0x22, 0x30 }, { 0x00, 0x03, 0x22, 0x99 },
            { 0x00, 0x32, 0x23, 0x99 }, { 0x00, 0x03, 0x22, 0x40 },
        ...
        },
        {
            ...
            { 0x00, 0x75, 0x57, 0x70 }, { 0x00, 0x15, 0x51, 0x00 },
            { 0x00, 0x32, 0x23, 0x00 }, { 0x04, 0x32, 0x22, 0x99 },
            { 0x90, 0x32, 0x23, 0x40 }, { 0x00, 0x32, 0x23, 0x00 },
            { 0x00, 0x42, 0x24, 0x00 }, { 0x00, 0x30, 0x30, 0x00 },
            { 0x03, 0x00, 0x30, 0x00 }, { 0x44, 0x00, 0x04, 0x40 }
        },
        {
...
{
    return playerPalette[PlayerSpritePaletteIndex(character, frame, x, y)];
}
...
int WINAPI wWinMain(HINSTANCE instance, HINSTANCE, PWSTR, int showCommand)
{
    ...
    while (running)
    {
        ...
        if (currentTime.QuadPart - previousUpdate.QuadPart >= updateInterval)
        {
            ...
            BYTE playerFrame = PlayerAnimationFrame(playerAlive,
                playerDashingThisUpdate, dashDistanceRemaining,
                dashDistanceCurrent, playerSlashVisualRemaining,
                playerMovedThisUpdate, playerWalkAnimTime);
            bool mirrorPlayer = playerDashingThisUpdate
                ? dashDirectionX < 0
                : (playerSlashVisualRemaining > 0.0f
